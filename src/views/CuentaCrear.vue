      ...
      <v-container>
        ...
        <v-row>
          <v-col cols="12" sm="6" md="3">
            <v-text-field label="Nombre de la cuenta"></v-text-field>
          </v-col>
          <v-col cols="12" sm="6" md="3">
            <v-text-field label="Número de la cuenta bancaria"></v-text-field>
          </v-col>
          <v-col cols="12" sm="6" md="3">
            <v-text-field label="Institucion Bancaria o comercial"></v-text-field>
          </v-col>
          <v-col class="d-flex" cols="12" sm="6">
            <v-select :items="tipo" label="Tipo de cuenta"></v-select>
          </v-col>
          <v-col class="d-flex" cols="12" sm="6">
            <v-select :items="color" label="Color"></v-select>
          </v-col>
          <v-col class="d-flex" cols="12" sm="6">
